...
export default function ShopCart() {
  ...
  useEffect(() => {
    const percentage = Math.min((totalPrice / 499) * 100, 100);
    console.log("percentage", percentage);
    document.querySelector(".progress-cart .value").style.width = `${percentage}%`;
  }, [totalPrice]); 
                        ...
                        <tr key={i} className="tf-cart-item file-delete">
                          ...
                          >
                            <div className="cart-price text-button price-on-sale">
                              ...
                              {elm.selectedSize ? (
                                <span> {parseInt(elm.selectedSize.price)} DH</span>
                              ): <span> {parseInt(elm.price)} DH</span>
                              }
                            </div>
                          </td>
                          <td
                          ...
                          >
                            <div className="cart-total text-button total-price">
                              {elm.selectedSize ? (
                                <span> {parseInt(elm.selectedSize.price)* elm.quantity} DH</span>
                              ): <span> {parseInt(elm.price)* elm.quantity} DH</span>
                              }
                            </div>
                          </td>
                          <td
