                            ...
                            <div className="tf-mini-cart-info flex-grow-1">
                              ...
                              <div className="d-flex align-items-center justify-content-between flex-wrap gap-12">
                                {product.selectedSize ? (
                                  <div className="text-secondary-2">{product.selectedSize.size.name} ml</div>
                                ) : ""}
                                
                                <div className="text-button">
                                  {product.quantity} X
                                  {product.selectedSize ? (
                                    <span> {parseInt(product.selectedSize.price)} DH</span>
                                  ): <span> {parseInt(product.price)} DH</span>
                                  }
                                </div>
                              </div>
                            </div>
